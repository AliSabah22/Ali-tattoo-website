...
module.exports = {
  ...
  theme: {
    extend: {
      colors: {
        // Professional tattoo artist color palette
        ink: {
          50: '#f8f9fa',
          100: '#e9ecef',
          200: '#dee2e6',
      ...
      animation: {
        ...
        'ink-splatter': 'ink-splatter 0.8s ease-out',
        'needle-pulse': 'needle-pulse 0.6s ease-in-out infinite',
        'blood-flow': 'blood-flow 1.5s ease-in-out infinite',
        'magnetic-pull': 'magnetic-pull 0.4s ease-out',
